********************************************************************
* term_16550 - /Term on the arm6309 TL16C550C (io/serial/docs/serial.md)
*
* The Wildbits sc16550desc, named /Term, at 115200.
*
* Edt/Rev  YYYY/MM/DD  Modified by
* Comment
* ------------------------------------------------------------------
*     1    2026/09/14  arm6309
* From level1/wildbits/modules/sc16550desc.asm.
...
rev                 set       $07
                    ...
                    fdb       UART.Base           physical controller address (defs/arm6309.d)
